...
An **event** compel is something that happens to a character because of an external force. That external force connects with the aspect in some way, resulting in an unfortunate complication. It looks like this:

_You have **BLANK** aspect and are in **BLANK** situation, so it makes sense that, unfortunately,  would happen to you. Damn your luck._
...
>
> Zird has **Rivals in the Collegia Arcana** and is attempting toget an audience with their Inner Council, so it makes sense that, unfortunately, his rivals force the Collegia to demand he provide a detailed account of his highly-coveted research to re-establish
his relationship with the organization. Damn his luck. 

A **decision** compel is internal, where the character’s flaws or competing values get in the way of better judgment. The aspect guides the character to make a particular choice—and the fallout of that choice creates a complication for them. It looks like this: 

_You have **BLANK** aspect in **BLANK**  situation, so it makes sense that you’d decide to **BLANK**. This goes wrong when **BLANK** happens._
...
>
>Zird has **Not the Face!** when he gets challenged to a barfight, so it makes sense that he’d decide to back down from the chal- lenge. This goes wrong when the rest of the patrons decide he’s a coward and throw him unceremoniously out into the street. Aspects and
...
As an example—you may wish to change the list to something more suitable to your setting—we’ll present you with five potential levels of scale:
